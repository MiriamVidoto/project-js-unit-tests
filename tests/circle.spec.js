...
// radius: 7, area: 153.86, circumference: 43.96
const circle7 = circle(7);
// radius: 3, area: 28,26, circumference: 18.84
const circle3 = circle(3);

describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contendo os valores esperados', () => {
    expect(circle7.radius).toBe(7);
    expect(circle7.area).toBeCloseTo(153.86 );
    expect(circle7.circumference).toBeCloseTo(43.96);
  });
    ...
    expect(Object.keys(circle1).length).toEqual(3);
  });
    ...
    expect(circle3).toHaveProperty ('circumference', 18.84);
  });  
    it( 'Teste se a função retorna, em um objeto, os dados corretos de um círculo de raio 3.', () => {
      expect(circle3.radius).toBe(3);
      expect(circle3.area).toBeCloseTo(28.26 );
      expect(circle3.circumference).toBeCloseTo(18.84);
  });
});
